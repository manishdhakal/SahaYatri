            ...
            <Row>
              <Col className="ml-auto mr-auto" md="8">
                ...
                <h5 className="description text-dark">
                  SahaYatri is an app that creates an interface between the local culture and tourists. Hire
            ...
            <Row>
              <Col md="4">
                <div className="info">
                  ...
                  <div className="description  text-dark">
                    <h4 className="info-title">Companions</h4>
              ...
              <Col md="4">
                <div className="info">
                  ...
                  <div className="description  text-dark">
                    <h4 className="info-title">Local Events</h4>
                    <p>
              ...
              <Col md="4">
                <div className="info">
                  ...
                  <div className="description  text-dark">
                    <h4 className="info-title">Cook {'&'} Dine </h4>
                    <p>
